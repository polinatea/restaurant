...
const AboutPage = () => {
  return (
    <div className='p-4 flex flex-col md:flex-row h-[calc(100vh-3rem)] gap-4 md:gap-0 mt:10 md:mt-0 text-sm md:text-base  text-green-600 lg:text-lg'>
        <div className='flex-1 flex flex-col justify-center gap-2 text-justify lg:pl-3 xl:pl-20 '>
            <h2 className='text-center text-base md:text-lg lg:text-xl font-bold'> About us:</h2>
      ...
      <div className=' flex flex-col items-center justify-center'>
        <h2 className='text-base md:text-lg font-bold mb-2 lg:text-xl'>We work:</h2>
